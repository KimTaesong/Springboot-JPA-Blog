...
public class DummyContorllerTest {
	...
	public User updateUser(@PathVariable int id, @RequestBody User requeUser) { // json 데이터를 요청 => Java Object(MessageConverter의 Jackson 라이브러리가 변환해서 받아줘요.) 
...
//		userRepository.save(user);
	...
	public User detail(@PathVariable int id) {
		...
		// Optional로 너의 User 객체를 감싸서 가져올테니 null인지 아닌지 판단해서 return해줘
	...
	// http://localhsot:8000/blog/dummy/join(요청)
